...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="col-md-6">
					<form role="form" method="get" action="../persistencia/PacienteDAO.php">
						<div class="form-group">
				...
				<div class="col-md-6">
						...
						<input type="submit" class="btn btn-primary" onclick="mostrarAlerta()" value ="Registrar">
					</div>	
	...
	function mostrarAlerta() {
		var nombre = document.getElementById("nombres").value;
  		var dnipac = document.getElementById("dni").value;
		var fecha = document.getElementById("fecha").value;
  		var telefono = document.getElementById("tele").value;

		if(nombre != "" && dnipac != "" && fecha!="" && telefono!=""){
			swal("Registro Satisfactorio!", "", "success");
		}else{
			swal("Faltan ingresar datos!", "", "warning");
		}
