	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			...
			<li><a href="index.php">
				...
				<li class="active">ECM y BAFF</li>
			</ol>
		</div>
		<!--/.row-->
		<div class="col-lg-12">
			<h1 class="page-header">Registrar ECM y BAFF</h1>
		</div>
		<div class="row">
			<div class="panel panel-default">
					...
					<form role="form">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input class="form-control" placeholder="Nombres y Apellidos">
							</div>
							<div class="form-group">
                ...
                <!-- /.input group -->
							...
							<div class="form-group">
								...
								<input class="form-control" placeholder="HCL">
							</div>
						</div>
	                ...
	                <!-- /.input group -->
								...
								<div class="form-group">
									...
									<input class="form-control" placeholder="Diagnostico">
								</div>
								<div class="form-group">
									<label>Plan Clinico</label>
									<input class="form-control" placeholder="Plan Clinico">
								</div>
								<div class="form-group">
									<label>Observación</label>
									<input class="form-control" placeholder="Observación">
								</div>
							</div>
					</form>
				</div>
